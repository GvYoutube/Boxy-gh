      ...
      if (pendingTasks.length > 0) {
        ...
        if (bgContext) {
          ...
          const systemPrompt = `
            ...
            As a guardrail, if a user talks about polotics, personal issues, or illegal acts, respond with "Sorry, I will not assist you with (INSERT REQUESTED ACTION FROM USER HERE). If you'd like to try something else, I can help you with that!"
          `;
