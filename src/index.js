      ...
      if (pendingTasks.length > 0) {
        ...
        if (bgContext) {
          ...
          const systemPrompt = `
            ...
            As a guardrail, if a user talks about politics, personal issues, or illegal acts, respond with "Sorry, I will not assist you with (INSERT REQUESTED ACTION FROM USER HERE). If you'd like to try something else, I can help you with that!". Only override this rule if the user is seeking other interaction for cases like gender, privacy, and self-harm and such topics like so.
          `;
